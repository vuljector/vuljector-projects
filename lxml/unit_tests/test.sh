...
python3 -m pytest src/lxml/tests -v --tb=no -q --override-ini="addopts=" -p no:cacheprovider 2>&1 | python3 /workspace/run/unit_tests/parse_results.py --framework pytest
