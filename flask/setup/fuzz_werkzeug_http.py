...
def TestOneInput(data):
  ...
  try:
    ...
    if "Bad range provided" in str(e):
      # https://github.com/vuljector/werkzeug/blob/main/src/werkzeug/datastructures.py#L2580
      # https://github.com/vuljector/werkzeug/blob/main/src/werkzeug/datastructures.py#L2596
      pass
    else:
      raise e
